...
export default LoanVotingPage;
                      ...
                      <div className="flex flex-col gap-3 min-w-[160px]">
                        <button
                          onClick={() => handleVote(vote.id, loan.id, true)}
                          disabled={processingId === vote.id || isSelf}
                          className="btn-primary bg-green-600 hover:bg-green-700 text-white flex items-center justify-center space-x-2"
                        >
                          {processingId === vote.id ? <Loader2 className="w-4 h-4 animate-spin" /> : <CheckCircle2 className="w-4 h-4" />}
                          <span>Approve</span>
                        </button>
                        <button
                          onClick={() => handleVote(vote.id, loan.id, false)}
                          disabled={processingId === vote.id || isSelf}
                          className="btn-outline border-destructive text-destructive hover:bg-destructive hover:text-destructive-foreground flex items-center justify-center space-x-2"
                        >
                          <XCircle className="w-4 h-4" />
                          <span>Reject</span>
                        </button>
